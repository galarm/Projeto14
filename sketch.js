...
function draw() {
  ...
  if(grupoFlechas.isTouching(grupoVermelho)){
    grupoFlechas.destroyEach()
    grupoVermelho.destroyEach()
    score= score +1
  }

  if(grupoFlechas.isTouching(grupoRosa)){
    grupoFlechas.destroyEach()
    grupoRosa.destroyEach()
    score= score +5
  }

  if(grupoFlechas.isTouching(grupoAzul)){
    grupoFlechas.destroyEach()
    grupoAzul.destroyEach()
    score= score +2
  }

  if(grupoFlechas.isTouching(grupoVerde)){
    grupoFlechas.destroyEach()
